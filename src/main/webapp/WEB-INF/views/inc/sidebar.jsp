...
<div class="sidebar-nav">
	...
	<ul id="dashboard-menu" class="nav nav-list collapse in">
		<li><a class="sidebar-menu" id="review_info" href="#">巡检历史<i class="icon-chevron-right"></i></a></li>
		<li><a class="sidebar-menu" id="station_info" href="#">配电设备站点配置<i class="icon-chevron-right"></i></a></li>
		<li><a class="sidebar-menu" id="checkpoint_info" href="#">配电设备缺陷配置<i class="icon-chevron-right"></i></a></li>
	</ul>
